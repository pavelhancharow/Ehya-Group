...
function accordionMenu() {
  var acc = document.querySelectorAll('.faq-card__heading'),
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, title, description, parentSelector) {
    ...
    _createClass(MenuCard, [{
      key: "render",
      value: function render(itemSelector) {
      ...
      value: function renderFeatures() {
        var elem = this.render('features-item');
        elem.innerHTML = "\n            <svg class=\"features-item__img card-icon\">\n              <use xlink:href=".concat(this.src, "></use>\n            </svg>\n            <span class=\"features-item__title\">").concat(this.title, "</span>\n            <span class=\"features-item__description\">").concat(this.description, "</span>\n            <a href=\"#\" class=\"features-item__link link\">\n              Learn more\n              <svg class=\"features-item__link_img arrow-more\">\n                <use xlink:href=\"img/svg/pointers.svg#arrow-right\"></use>\n              </svg>\n            </a>\n        ");
        this.parent.append(elem);
      }
    }, {
      key: "renderHero",
      value: function renderHero() {
        var elem = this.render('hero-card');
        elem.innerHTML = "\n            <svg class=\"hero-card__img card-icon\">\n              <use xlink:href=".concat(this.src, "></use>\n            </svg>\n            <div class=\"hero-card__info\">\n              <strong class=\"hero-card__title\">").concat(this.title, "</strong>\n              <span class=\"hero-card__subtitle\">").concat(this.description, "</span>\n            </div>\n        ");
        this.parent.append(elem);
      }
    }, {
      key: "renderInformation",
      value: function renderInformation() {
        var elem = this.render('information-card');
        elem.innerHTML = "\n              <div class=\"information-card__oval\">\n                <svg class=\"information-card__img info-sprites\">\n                  <use xlink:href=".concat(this.src, "></use>\n                </svg>\n              </div>\n              <span class=\"information-card__info\">").concat(this.title, "</span>\n              <span class=\"information-card__text\">").concat(this.description, "</span>\n        ");
        this.parent.append(elem);
      }
    }]);
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResours)('db.json').then(function (data) {
    data.featuresCards.forEach(function (_ref) {
      var img = _ref.img,
          title = _ref.title,
          descr = _ref.descr;
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResours)('db.json').then(function (data) {
    data.heroCards.forEach(function (_ref2) {
      var img = _ref2.img,
          title = _ref2.title,
          descr = _ref2.descr;
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResours)('db.json').then(function (data) {
    data.informationCards.forEach(function (_ref3) {
      var img = _ref3.img,
          title = _ref3.title,
          descr = _ref3.descr;
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _services_effects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/effects */ "./js/services/effects.js");
...
var sendForm = function sendForm() {
  ...
  form.addEventListener('submit', function (e) {
    ...
    inputs.forEach(function (input, i) {
      if (input.value === '') {
        (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.inputError)(input, input.parentElement);
      } else if (i === 3 && !input.checked) {
        (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.unchecked)(input);
      }
    });
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_6__.postData)(object).then(function (resolve) {
      ...
      form.reset();
      setTimeout(function () {
        (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.modalClose)(modal, inputs);
      }, 1500);
    });
  });
};
...
function hamburgerMenu() {
  ...
  menuListItem.forEach(function (item) {
    return item.addEventListener('click', function (e) {
      e.preventDefault();
      var listActive = item.lastElementChild.classList.contains('drop-list__active'),
      ...
      dropListItem.forEach(function (list) {
        var listActive = list.lastElementChild.classList.contains('service-list__active');
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _services_effects__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/effects */ "./js/services/effects.js");
...
function popUp() {
  ...
  openModal.forEach(function (openModal) {
    return openModal.addEventListener('click', modalOpen);
  });
  closeModal.addEventListener('click', function () {
    return (0,_services_effects__WEBPACK_IMPORTED_MODULE_2__.modalClose)(modal, inputs, modalForm);
  });
  modal.addEventListener('click', function (e) {
    return e.target === modal ? (0,_services_effects__WEBPACK_IMPORTED_MODULE_2__.modalClose)(modal, inputs, modalForm) : null;
  });
}
...
function animateScroll() {
  ...
  var varible = sponsors.getBoundingClientRect().height / 2;
  window.addEventListener('scroll', function () {
    if (sponsors.offsetTop - document.documentElement.scrollTop <= varible + 50 && sponsors.offsetTop - document.documentElement.scrollTop >= -varible) {
      ...
      items.forEach(function (item) {
        return item.classList.remove('sponsors-container__item_size');
      });
    }
  });
}
...
function sliderAuto() {
  ...
  var resizeScreen = function resizeScreen() {
    var width = window.getComputedStyle(slider).width;
    var offset = 0,
        interval;
    var xDown = null,
        yDown = null;
    sliderInner.style.transform = "translateX(".concat(offset, "px)");
    sliderInner.style.width = "".concat(100 * slides.length, "%");
...
function tabs() {
  ...
  typeParent.addEventListener('click', function (e) {
  ...
  function createSpan(name, changeName, newName) {
    ...
    lineParent.insertAdjacentHTML('beforeend', "\n        <span class=\"install-line__item\"><span class=\"install-line__item_bold\">$</span>\n                ".concat(name, " install <span class=\"install-line__item_aqua\">-g</span> ehya.js|</span>\n      "));
  }

  function showResult(iterator) {
    for (var i = 0; i < lineParent.children.length; i++) {
      var elem = lineParent.children[i];
...
function validation() {
  var enterInputs = document.querySelectorAll('[data-input]');

  function validateEmail(input, label) {
    var re = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;

    if (re.test(String(input.value).toLowerCase())) {
      (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.inputValid)(input, label);
      return;
    } else if (input.value === '') {
      (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.inputValid)(input, label);
    } else {
      (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.inputError)(input, label);
    }
  }

  enterInputs.forEach(function (item) {
  ...
  enterInputs.forEach(function (item) {
    return item.addEventListener('input', function () {
      if (item.id === 'singUp-name') {
        ...
        (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.inputValid)(item, item.parentElement);
        ...
        (0,_services_effects__WEBPACK_IMPORTED_MODULE_5__.checked)(item);
      }
    });
  });
}
...
/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/validation */ "./js/modules/validation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_validation__WEBPACK_IMPORTED_MODULE_9__.default)();
});

/***/ }),

/***/ "./js/services/effects.js":
/*!********************************!*\
  !*** ./js/services/effects.js ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "inputValid": function() { return /* binding */ inputValid; },
/* harmony export */   "unchecked": function() { return /* binding */ unchecked; },
/* harmony export */   "checked": function() { return /* binding */ checked; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_array_slice_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.array.slice.js */ "./node_modules/core-js/modules/es.array.slice.js");
...
function inputError(input, label) {
  if (label.lastElementChild.tagName === "SPAN") {
    ...
    span.textContent = "Enter correct ".concat(input.name[0].toUpperCase() + input.name.slice(1));
    label.append(span);
...
var postData = function postData(object) {
